...
void WeatherManager::setFallbackWeather(Weather& weather,const std::string& name)
{
    ...
    weather.mTransitionDelta = mFallback->getFallbackFloat("Weather_"+upper+"_Transition_Delta", .1f);
    ...
    weather.mAmbientSunriseColor = mFallback->getFallbackColour("Weather_"+upper+"_Ambient_Sunrise_Color", Ogre::ColourValue(.2f, .2f, .2f));
    weather.mAmbientDayColor = mFallback->getFallbackColour("Weather_"+upper+"_Ambient_Day_Color", Ogre::ColourValue(.2f, .2f, .2f));
    weather.mAmbientSunsetColor = mFallback->getFallbackColour("Weather_"+upper+"_Ambient_Sunset_Color", Ogre::ColourValue(.2f, .2f, .2f));
    weather.mAmbientNightColor = mFallback->getFallbackColour("Weather_"+upper+"_Ambient_Night_Color", Ogre::ColourValue(.2f, .2f, .2f));
    ...
    weather.mLandFogDayDepth = mFallback->getFallbackFloat("Weather_"+upper+"_Land_Fog_Day_Depth", 3.0f);
    weather.mLandFogNightDepth = mFallback->getFallbackFloat("Weather_"+upper+"_Land_Fog_Night_Depth", 3.0f);
